...
public class ToLastResultResfinder implements Function<String, LastResultResfinder> {

    @Override
    public LastResultResfinder call(String s) throws Exception {
        ...
        if(fields.length==15) {
            ...
            return new LastResultResfinder(fields[0], fields[1], pI, al, mm, go, qs, qe, rs, re, ev, bs, ql, rl);
        }else {
            return null;
        }
    }
